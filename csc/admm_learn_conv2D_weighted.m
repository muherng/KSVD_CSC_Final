function [ d_res, z_res, Dz, obj_val, iterations ] = admm_learn_conv2D_weighted(b, kernel_size, ...
    ...
    for i = 1:max_it
        ...
        if psf_s == 7
            save('z_res7.mat','z_res');
            save('d_res7.mat','d_res');
        elseif psf_s == 8
            save('z_res8.mat','z_res');
            save('d_res8.mat','d_res');
        elseif psf_s == 9
            save('z_res9.mat','z_res');
            save('d_res9.mat','d_res');
        elseif psf_s == 10
            save('z_res10.mat','z_res');
            save('d_res10.mat','d_res');
        end
